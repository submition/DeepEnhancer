...
class Reconstruction_Metrics:
    ...
    def calculate_metric(self, fake_image_path, real_image_path):
        ...
        for i, (image_path_real,image_path_fake) in enumerate(zip(frame_path_real,frame_path_fake)):
            ...
            PIL_real = Image.open(path_real).convert('L')
            PIL_real = PIL_real.convert('RGB')
            PIL_fake = Image.open(path_fake).convert('L')
...
if __name__ == "__main__":
    # real_path = '/home/wanziyu/workspace/datasets/CVPR2022/synthetic_test_set/gt'
    # fake_path = '/home/wanziyu/workspace/outputs/CVPR2022/Ablation/RNN_Swin_Single'
    real_path = '/degraded_datasets/davis_old_film_240_gt'
    fake_path = '/home/jq/Color/Old_film_restoration/visual_results_retore/Inpainter_v1/DAVIS4/davis_old_film_lq'
