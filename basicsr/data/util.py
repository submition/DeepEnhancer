...
if __name__ == '__main__':
    ...
    """get image path list from lmdb meta info"""
    dataroot = '/home/jq/Color/TCVC-Temporally-Consistent-Video-Colorization-main/codes/lists'
    meta_info = pickle.load(open(os.path.join(dataroot, 'DAVIS_videvo_train.pkl'), 'rb'))
