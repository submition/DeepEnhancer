...
from basicsr.common import (PixelShufflePack, ResidualBlockNoBN,
                                  make_layer)
...
class PCDAlignment(nn.Module):
    ...
    def __init__(self, num_feat=64, deformable_groups=8):
        ...
        for i in range(3, 0, -1):
            ...
            self.dcn_pack[level] = ModulatedDCNPack(num_feat, num_feat, 3, padding=1, deformable_groups=deformable_groups)
        ...
        self.cas_dcnpack = ModulatedDCNPack(num_feat, num_feat, 3, padding=1, deformable_groups=deformable_groups)
...
class EDVR(nn.Module):
    ...
    def __init__(self,
        ...
        # reconstruction
        self.reconstruction = make_layer(ResidualBlockNoBN, num_reconstruct_block, mid_channels=num_feat)
        # upsample
