...
class RCAB(nn.Module):
    def __init__(self, conv=default_conv, n_feat=64, kernel_size=3, reduction=1, bias=True, bn=False, act=nn.ReLU(True),
                 res_scale=1):
...
class ResidualGroup(nn.Module):
    def __init__(self, conv=default_conv, n_feat=64, kernel_size=3, reduction=1, act=nn.ReLU(True), res_scale=1,
                 n_resblocks=30):
